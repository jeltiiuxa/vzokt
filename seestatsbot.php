...
$lines_cashe=file_get_contents("base_bot", LOCK_EX);
$file=explode("\n",$lines_cashe);
$size_f=count($file)-1;
?>
...
<center>
<?php
echo 'сейчас на сервере ' . date("H:i:s d.m.Y") ;
if ($col>$size_f) $col=$size_f;
echo '<br>Последние <b>'.$col.'</b> посещений сайта:';
?>

<table width="750" cellspacing="1" cellpadding="1" border="0"
    style="table-layout:fixed">
<tr bgcolor="#eeeeee">
 <td class="zz" width="115"><b>Время, дата</b></td>
 <td class="zz" width="490"><b>Кто посещал</b></td>
...
echo '<td class=zz><a href="'.$str[3].'">'.$str[3];
echo '</a></td></tr>';
}
echo '</table>';
